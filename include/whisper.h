...
extern "C" {
    ...
    enum whisper_sampling_strategy {
        ...
        WHISPER_SAMPLING_OPTIMIZED_BEAM_SEARCH,  // optimized beam search defined by us
    };
    ...
    WHISPER_API std::string print_token_timestamp_vector_list_transcript(const std::vector<std::tuple<double, double, std::string>>& committed);
